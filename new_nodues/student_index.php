								...
								<?php
										...
										echo "<tr>
											...
											echo "</td>";
												...
												echo "<td><a href='./view_due.php?due_id=".$data["due_id"]."'> <button class='btn btn-primary'".">View</button></a>";
								...
								<?php
										...
										echo "<tr>
											...
											if($data["current_status"]=="N"){
												...
												echo "Requested";
												echo ' / <a href=./make_request.php?due_id='.$data["due_id"].'>Edit Request
													</a>';
											}
											...
											echo "</td>";
											echo "<td><a href='./view_due.php?data=".$data["due_id"]."'> <button class='btn btn-primary'".">View</button></a>";
											echo "</tr>";
											//$curr_lab_total=$curr_lab_total+$data["amount"];
											//$curr_dept_total=$curr_dept_total+$data["amount"];
										}	
