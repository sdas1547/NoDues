		...
		<div class="container">
			<div class="row">
				...
				<?php
					...
					$viewname="view_".$programme;
							$creating_view= "create or replace view ".$viewname." as select dues.entry_number,student_table.department_code,student_table.programme as category, sum(amount) as total_amount from dues join student_table where dues.entry_number=student_table.entry_number and (status='P' or status='R')  group by entry_number";
					...
					if($programme=='ug'){
						...
						{
							 $pending_sql = "SELECT * FROM ".$viewname. " where (category='phd' or category='msr' or category='mtech')";
