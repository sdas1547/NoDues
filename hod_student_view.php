<html>
	...
	<?php
		...
		if(isset($_POST["entry_number"])){
			...
			$entry_number = $_SESSION["temp_entry"];
		}
	?>	
		...
		<div class="container">
			<div class="row">
				<ul>
					...
					<hr>
				<ul>
					<li> <h4><strong>Student Dues:  <?php echo $entry_number;?></strong></h4>
						<br><br>
						...
						<div class="tab-content">
							<div id="pending" class="tab-pane fade in active">
								<?php
									$student_pending = "student_pending".$admin_id;
									...
									$lab_details = "lab_details".$admin_id;
									...
									$employee_details = "employee_details".$admin_id;
								...
								?>
												<td>
													<form style="margin:0px; padding:0px;" method="POST" action="./view_due.php">
														<input name="entry_number" value=<?php echo $entry_number;?> type="hidden">
														<input name="due_id" value=<?php echo $data["dueID"];?> type="hidden">
														<button type="submit" class="btn-link">View</button>
													</form>
												</td>
											</tr>
								<?php
							...
							<div id="requested" class="tab-pane fade">
								<?php
									$student_requested = "student_requested".$admin_id;
									...
									$req_lab_details = "req_lab_details".$admin_id;
									...
									$req_dueIDs = "req_dueIDs".$admin_id;
									$requested_dues_sql6 = "CREATE OR REPLACE VIEW $req_dueIDs AS
																SELECT dueID
																	FROM $student_requested;";

									$req_details = "req_details".$admin_id;
							...
							<div id="approved" class="tab-pane fade">
								<?php
									$student_approved = "student_approved".$admin_id;
									...
									$approve_labDues = "approve_labDues".$admin_id;
									$approved_dues_sql2 = "CREATE OR REPLACE VIEW $approve_labDues AS
																SELECT DISTINCT lab_code, employee_uID
																	FROM $student_approved;";

									$approve_labHeader = "approve_labHeader".$admin_id;
									...
									$approve_lab_details = "approve_lab_details".$admin_id;
									...
									$approve_dueIDs = "approve_dueIDs".$admin_id;
									$approved_dues_sql6 = "CREATE OR REPLACE VIEW $approve_dueIDs AS
																SELECT dueID
																	FROM $student_approved;";

									$approve_details = "approve_details".$admin_id;
