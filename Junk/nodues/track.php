...
<html>
    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="/nodues/welcome.php">Home </a></li>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="/nodues/welcome.php">Home</a>
                </li>
       ...
       $user=$_SESSION['id'];
    $sql_query="SELECT * from requests where userid='$user'";
    ...
    ?>
        ...
        <div class="container" style="padding-top:50px; margin-left:250px;">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-sm-offset-3">
                    <p style="font-family:Prociono; font-size:3em;">Status</p>
                </div>
            </div>
        ...
        if(mysqli_num_rows($res)<1)
            echo "Please submit Nodues clearance to track ";
        ...
        ?>
                ...
                $query="SELECT * from places where place_id='$place'";
         $e=mysqli_query($connection,$query);
         while($r=mysqli_fetch_array($e))
        {            $placename=$r['place_name'];
        }
         echo '<div class="col-sm-4 col-xs-4"><p style="font-family:Prociono; font-size:1.5em;">'; echo $placename;
                        echo "</div>";
