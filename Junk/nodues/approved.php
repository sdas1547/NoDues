...
<html>
    ...
    $sql_query="SELECT * from requests where place_id='$place_id' and status=1";
    ...
    ?>
        ...
        <div class="container" style="padding-top:50px; margin-left:250px;">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-sm-offset-3">
                    <p style="font-family:Prociono; font-size:3em;">Aprooved Requests</p>
                </div>
            </div>
        ...
        ?>
             ...
             echo'<button class="btn btn-success">'; echo "Approve";echo '</button>';
                }
                else
                {
