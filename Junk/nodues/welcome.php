...
window.onhashchange=function(){window.location.hash="#";}
    ...
    <div class="container">
        ...
        <div class="container" style="padding-top:100px; margin-left:250px;">
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <p style="font-family:Fertigo; font-size:30px;">Click to view your pending dues. <a href="view_pending.php"><button class="btn btn-primary">Pending</button></p></a>
                </div>
                <br>
                <br><br><br><br><br>
             ...
             <form class="form-horizontal" role="form" method="post" action="request.php">
                 ...
                 <div class="col-xs-12 col-sm-12">
                     ...
                     <p style="font-family:Fertigo; font-size:30px;">Request NoDues Clearance 
                         
                         <input type=hidden value="1" name="depcode"/>
                      
                         
                         
                         
                         
                         <button type=submit class="btn btn-primary">Make Request</button></p>
                </div>
            </form>
        ...
        <p id='file'> Track status of submitted request  <a href="track.php"><button class="btn btn-primary">Track Status</button></a>
            </p>
        </div>
