	...
	<div class="container">
		...
		<form class="form-horizontal" method="post" action="">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" maxlength="11" placeholder="Enter Entry Number" type="text" name="entry_num" value="<?php echo $entry_num;?>" id="entry_n" onkeyup	="checkInput('entry_n')"   onchange	="checkInput('entry_n')" oninput="checkInput('entry_n')">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" placeholder="Name" type="text" name="name" value="<?php echo $entry_num;?>" id="name">
				</div>
				<span class="error">* <?php echo $entryErr; ?> </span>
			</div>
